    ...
    return (
        <div>
            <footer className="footer footer-center p-10 bg-black text-primary-content">
                <aside>
                    <img className="w-20" src="https://i.ibb.co/H43mt5X/download-25.jpg" alt="" />
                    <p className="font-bold text-2xl">
                        Sweet Residences <br /><span className="font-medium text-base">Providing reliable living places since 2010</span>
                    </p>
